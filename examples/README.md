...
|---|---|---|
| `S` | `window.ChartSupportMode` | Support mode enum alias. |
| `F` | `window.ChartFunctions` | Distribution function factory alias. |
...
| `mode` | support enum | `S.FINITE_AB`, `S.A_INF`, `S.NINF_INF` | Support interval strategy. |
